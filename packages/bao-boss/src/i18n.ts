...
const messages: Record<string, Record<string, string>> = {
  en: {
    ...
    'confirm.bulkRetry': 'Retry selected jobs?',
    'confirm.bulkCancel': 'Cancel selected jobs?',
    'msg.bulkInvalid': 'Invalid bulk request',
    'msg.bulkEmpty': 'No jobs selected',
    'table.name': 'Name',
    'table.policy': 'Policy',
